...
export const toursData: TourPlan[] = [
  {
    id: "00",
    title: "tours.tour0.title",
    subtitle: "tours.tour0.subtitle",
    duration: "tours.tour0.duration",
    route: "BIA/Colombo - Sigiriya - Kandy - Nuwaraeliya - Ella - Yala - Galle - BIA",
    description: "tours.tour0.description",
  ...
  {
    id: "01",
    title: "tours.tour1.title",
    subtitle: "tours.tour1.subtitle",
    duration: "tours.tour1.duration",
  ...
  {
    id: "02",
    title: "tours.tour2.title",
    subtitle: "tours.tour2.subtitle",
    duration: "tours.tour2.duration",
  ...
  {
    id: "03",
    title: "tours.tour3.title",
    subtitle: "tours.tour3.subtitle",
    duration: "tours.tour3.duration",
  ...
  {
    id: "04",
    title: "tours.tour4.title",
    subtitle: "tours.tour4.subtitle",
    duration: "tours.tour4.duration",
  ...
  {
    id: "05",
    title: "tours.tour5.title",
    subtitle: "tours.tour5.subtitle",
    duration: "tours.tour5.duration",
